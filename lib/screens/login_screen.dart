...
class _LoginScreenState extends State<LoginScreen> with WidgetsBindingObserver {
      ...
      body: SafeArea(
          child: SingleChildScrollView(
            ...
            children: [
              ...
              // Login Button
              !_isLoading
                  ? CustButton(label: 'LOGIN', onPressed: _login)
  ...
  void _login() async {
    ...
    try {
      var uri = Uri.https(Urls.baseUrl, Urls.adminLoginUrl);
      ...
      if (response.statusCode == 200) {
        ...
        pref.setString(
            Consts.Token, rawData['data']['user']['hostelAdminToken']);
        pref.setString(
